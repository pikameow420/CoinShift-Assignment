...
export type SafeConnectParameters = Evaluate<
    {
        /**
...
safeConnect.type = 'safeConnect' as const
export function safeConnect(parameters: SafeConnectParameters) {
    ...
    let accountsChanged: SafeConnector['onAccountsChanged'] | undefined
    let chainChanged: SafeConnector['onChainChanged'] | undefined
    let connect: SafeConnector['onConnect'] | undefined
    let displayUri: SafeConnector['onDisplayUri'] | undefined
    let sessionDelete: SafeConnector['onSessionDelete'] | undefined
    let disconnect: SafeConnector['onDisconnect'] | undefined

    return createConnector<Provider, Properties, StorageItem>((config) => ({
        id: 'safeConnect',
        name: 'SafeConnect',
        type: safeConnect.type,
        async setup() {
